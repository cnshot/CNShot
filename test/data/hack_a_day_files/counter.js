...
//			SiteMeter.onPageLoad();
	...
	onPageLoad:function()
	{
		...
		flashIFrame.width = 1;
		flashIFrame.height = 0;
		flashIFrame.marginwidth = 0;
		flashIFrame.marginheight = 0;
		flashIFrame.src = "http://cdn4.specificclick.net/img/?ag=2&pb=d4133&pg=&us=&nwk=1&rnd="+sm_random;
		...
		if (parentOfScript){
			...
			parentOfScript.insertBefore(flashIFrame,scriptRef); 
		}
		else
...
SiteMeter.init('sm6hackaday', 'sm6.sitemeter.com', '');

var g_sLastCodeName = 'sm6hackaday';
// ]]>
